...
main.title("โปรแกรมเช็คเกรด โดย ธนวัตน์ แสงม่วง")
answer=StringVar()
...
lb6=Label(main, text="คำตอบ", font=("Tahoma",24), textvariable=answer)
...
btn=Button(main, text="คำนวณ", font=("Tohama",24), command=Checkgrade)
